...
initMap();renderDomains();renderSimulation();saveQueue(queued());Promise.all([refreshEvents(),refreshTracks(),refreshDeconfliction(),refreshZones(),refreshAlerts(),refreshExecutive(),refreshTasks(),refreshReadiness(),refreshComms(),refreshIntegrations()]);flushOffline();
setInterval(()=>Promise.all([refreshEvents(),refreshTracks(),refreshDeconfliction(),refreshAlerts(),refreshExecutive(),refreshTasks(),refreshReadiness(),refreshComms(),refreshIntegrations()]),5000);
"""
