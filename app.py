...
let map, mapMarkers=[], trackMarkers=[], trackPathLayers=[], conflictLayers=[], simMarkers=[], simTrails=[];
...
initMap();renderDomains();renderSimulation();saveQueue(queued());Promise.all([refreshEvents(),refreshTracks(),refreshDeconfliction(),refreshTasks(),refreshReadiness(),refreshComms(),refreshIntegrations()]);flushOffline();
